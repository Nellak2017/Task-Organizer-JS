...
const ExpandingAnimation = keyframes`
    0% { opacity: 0; min-height: 0; padding: 0; margin: 0 0 0 0;}
    100% { opacity: 1; min-height: 10rem;}
`;

const CollapsingAnimation = keyframes`
    0% { opacity: 1; min-height: 10rem;}
    100% { opacity: 0; min-height: 0; padding: 0; margin: 0 0 0 0;
}
`;
...
export const SummaryInfoCollapsable = styled.section`
    ...
    & *{
        ...
        "transition-timing-function: linear; transition: 400ms;":NestedComponentAnimationFix
        };
