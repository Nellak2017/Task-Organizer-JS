...
export const TaskTable = styled.table`
    ...
    & .due[data-content*="ago"] span{color: black; background-color: rgba(255,199,206);}
    & .due[data-content*="Yesterday at"] span{color: black; background-color: rgba(255,199,206);}
