/*
    This component serves as a placeholder for the sites that are not currently created yet.
    It is to tell users that the site is not ready yet. 
*/
import {
    Styles
} from './UnderConstruction.elements.js';
            ...
            <Styles>
                <body>
                    <div className="warning-content">
                        ...
                        <p>Please forgive the inconvenience.<br />
                            I am currently making my new site.</p>
